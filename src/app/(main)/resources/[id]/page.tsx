    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="p-8">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-500 mb-8">
            {resource.createdBy.fullName && (
              <span>By {resource.createdBy.fullName}</span>
            )}
            <span>
              Published {resource.createdAt.toLocaleDateString("en-US", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-8 py-6 flex items-center justify-between">
          ...
          {resource.isFree && resource.fileUrl ? (
            <a
            ...
            <Button size="lg">Purchase to Access</Button>
          )}
        </div>
      </div>
    </div>
